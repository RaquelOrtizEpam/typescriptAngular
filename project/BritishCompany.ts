...
company1.addEmployee(new Employee("Peter", "Project A"));
company1.addEmployee(new Employee("Charlie", "Project B"));
...
company2.addEmployee(new Employee("Ellie", "Project X"));
company2.addEmployee(new Employee("Jack", "Project Y"));
